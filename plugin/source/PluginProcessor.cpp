...
AudioPluginAudioProcessor::AudioPluginAudioProcessor()
     : AudioProcessor (BusesProperties()
                       ...
                       , tracker{TrackerList(DEFAULT_BEAT_TRACKER)} // beatnet is the default param but we excplicitly initialize with btrack..
{
...
bool AudioPluginAudioProcessor::isHostPlaying() const
{
                                              ...
                                              juce::MidiBuffer& midiMessages)
{
    if ( isHostPlaying() )
    {
        ...
        bool isBeat = tracker.operate( currBuffer, totalNumInputChannels);
        
        if (isBeat)
        {
            DBG("Tick");
            beatStatus.store(isBeat , std::memory_order_release);
        }
